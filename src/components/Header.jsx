            ...
            <nav className="bg-white border-b-2 dark:border-b-1 dark:border-gray-900 border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                    ...
                    <div id="mobile-nav" className="flex md:order-2">
                        <button onClick={()=> setDarkMode(!darkMode)} className="text-xl mr-3 dark:text-gray-300 ">
                            {darkMode ? <IoIosSunny /> : <MdOutlineDarkMode />}
                        </button>
                        ...
                        <div className="relative hidden md:block">
                            ...
                            <form onSubmit={handleSubmit}>
                                <input type="text" id="search-navbar2" name="search" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." autoComplete="off"/>
                            </form>
